...
<!-- End Features -->
<!-- Features -->
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 bg-v lg:py-14 bg-violet-100 mx-auto">
  <!-- Grid -->
  <div class="mt-10 grid gap-6 grid-cols-2 sm:gap-12 lg:grid-cols-3 lg:gap-8">
    <!-- Stats -->
    <div>
    ...
    <!-- Stats -->
    <div>
      <h4 class="text-lg sm:text-xl font-semibold text-gray-800 dark:text-gray-200">Chefs and menus</h4>
